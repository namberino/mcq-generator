...
from utils import generate_mcqs_from_text, _post_chat, _safe_extract_json, save_markdown_local
...
class RAGMCQ:
    ...
    def build_index_from_pdf(self, pdf_path: str, max_chars: int = 1200):
        ...
        save_markdown_local(file_content=self.texts)
